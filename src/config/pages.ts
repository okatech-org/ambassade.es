...
export const HEADER_SECTION: SectionDef = {
	...
	fields: [
		...
		},
		{
			...
			label: "Nom (ligne 1)",
			fieldType: "text",
			defaultValue: "AMBASSADE DU GABON",
		},
		{
			contentKey: "layout.header.brand.line2",
			label: "Nom (ligne 2)",
			fieldType: "text",
			defaultValue: "Près le Royaume d'Espagne",
		},
		{
...
export const PAGE_REGISTRY: Record<string, PageDef> = {
	...
	ambassade: {
		slug: "ambassade",
		title: "Ambassade",
		description: "Présentation de l'Ambassade, équipe diplomatique et missions",
		...
		sections: [
				...
				fields: [
					{
						...
						label: "Image de fond",
						fieldType: "image",
						defaultValue: "/images/ambassade_espagne.png",
					},
					{
					...
					},
					{
						...
						fieldType: "text",
						defaultValue:
							"L'Ambassade de la République Gabonaise auprès du Royaume d'Espagne et Représentation Permanente auprès d'ONU Tourisme, sous la direction de S.E. Madame Allegra Pamela Bongo, assure la représentation diplomatique du Gabon, la protection des ressortissants gabonais et le renforcement des relations bilatérales. Depuis 1964, le Gabon et l'Espagne entretiennent des relations diplomatiques solides dans les domaines politique, économique, culturel et militaire.",
					},
					{
			...
			},
			{
				...
				description: "Photo, titre et message de l'Ambassadeur",
				icon: MessageSquare,
				fields: [
					{
						contentKey: "consulat.consul.photo",
						label: "Photo de l'Ambassadeur",
						fieldType: "image",
						defaultValue: "/images/ambassadrice.png",
					},
					{
						contentKey: "consulat.consul.name",
						label: "Nom complet",
						fieldType: "text",
						defaultValue: "Allegra Pamela BONGO",
					},
					{
						contentKey: "consulat.consul.role",
						label: "Fonction",
						fieldType: "text",
						defaultValue: "Ambassadeur de la République Gabonaise\nPrès le Royaume d'Espagne\nReprésentante Permanente auprès d'ONU Tourisme",
					},
					{

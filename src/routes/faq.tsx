...
function FAQPage() {
  ...
  const faqItems: { question: string; answer: string; category: FaqCategory }[] = [
    ...
    { question: t('faq.items.17.question', "Comment saisir le Consul Général en cas d'insatisfaction ?"), answer: t('faq.items.17.answer', "En cas d'insatisfaction concernant un service rendu par le consulat, vous pouvez adresser une réclamation écrite au Consul Général. Par courrier : 26 bis, avenue Raphaël — 75016 Paris. Par email : consulatgeneralgabon@yahoo.fr. Votre réclamation sera examinée et vous recevrez une réponse dans les meilleurs délais."), category: 'consulat' },

	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			await createPost({
				...
				coverImageStorageId: formData.coverImageStorageId
					? (formData.coverImageStorageId as any)
					: undefined,
				...
				...(formData.category === "evenement" && {
					...
					eventEndDate: formData.eventEndDate
						? new Date(formData.eventEndDate).getTime()
						: undefined,
				...
				...(formData.category === "communique" && {
					...
					documentStorageId: formData.documentStorageId
						? (formData.documentStorageId as any)
						: undefined,
		...
		<div className="flex flex-1 flex-col gap-4 p-4 pt-6">
			<div className="flex items-center gap-4">
				...
				<div>
					...
					<p className="text-muted-foreground">
						{t(
							"admin.posts.newDesc",
							"Créer une nouvelle actualité, événement ou communiqué",
						)}
					</p>
				</div>
			</div>
			...
			<form onSubmit={handleSubmit} className="space-y-6">
				...
				<Card>
					<CardHeader>
						<CardTitle>
							{t("admin.posts.form.title", "Contenu de l'article")}
						</CardTitle>
					</CardHeader>
					<CardContent className="space-y-6">
						<div className="grid gap-4 md:grid-cols-2">
							<div className="space-y-2">
								<Label htmlFor="title">
									{t("admin.posts.form.titleLabel", "Titre")} *
								</Label>
								<Input
									id="title"
									...
									placeholder={t(
										"admin.posts.form.titlePlaceholder",
										"Titre de l'article",
									)}
								/>
							</div>
							<div className="space-y-2">
								<Label htmlFor="slug">
									{t("admin.posts.form.slug", "Slug (URL)")}
								</Label>
								<Input
									id="slug"
									value={formData.slug}
						...
						<div className="grid gap-4 md:grid-cols-3">
							<div className="space-y-2">
								<Label htmlFor="category">
									{t("admin.posts.form.category", "Type")}
								</Label>
								<Select
							...
							<div className="space-y-2">
								<Label htmlFor="status">
									{t("admin.posts.form.status", "Statut")}
								</Label>
								<Select
						...
						<div className="space-y-2">
							<Label htmlFor="excerpt">
								{t("admin.posts.form.excerpt", "Résumé")} *
							</Label>
							<Textarea
								id="excerpt"
								...
								placeholder={t(
									"admin.posts.form.excerptPlaceholder",
						...
						<div className="space-y-2">
							<Label htmlFor="content">
								{t("admin.posts.form.content", "Contenu (Markdown)")} *
							</Label>
							<Textarea
								id="content"
								...
								placeholder={t(
									"admin.posts.form.contentPlaceholder",

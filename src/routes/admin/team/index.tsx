...
import { Plus, Edit, Trash2, Eye, EyeOff, Crown, GripVertical } from 'lucide-react'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {t('admin.team.description', 'Gérer les membres de l\'équipe consulaire')}
          </p>
        </div>
        <Button asChild>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t('admin.team.columns.member', 'Membre')}</TableHead>
                  <TableHead>{t('admin.team.columns.role', 'Fonction')}</TableHead>
                  <TableHead>{t('admin.team.columns.status', 'Statut')}</TableHead>
                  ...
                  <TableRow key={member._id}>
                    ...
                    <TableCell className="text-right space-x-1">
                      ...
                      <Button variant="ghost" size="icon" asChild>
                        <Link to="/admin/team/$memberId/edit" params={{ memberId: member._id }}>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t('admin.team.deleteConfirmDesc', 'Cette action est irréversible. Le membre sera définitivement supprimé.')}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

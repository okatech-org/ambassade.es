	...
	const filterableColumns = [
		{
			...
			options: [
				{
					label: t("superadmin.services.categories.passport"),
					value: "passport",
				},
				{ label: t("superadmin.services.categories.visa"), value: "visa" },
				{
					label: t("superadmin.services.categories.civil_status"),
					value: "civil_status",
				},
				{
					label: t("superadmin.services.categories.registration"),
					value: "registration",
				},
				{
					label: t("superadmin.services.categories.legalization"),
					value: "legalization",
				},
				{
					label: t("superadmin.services.categories.emergency"),
					value: "emergency",
				},

	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				detail:
					"Bourses de l'État gabonais : via l'ANBG (Agence Nationale des Bourses du Gabon). Bourses espagnoles : BCS (Bourse sur critères sociaux, via le Becas MEC — conditions de revenus). Bourses d'excellence : Eiffel Romain, Erasmus+, bourses régionales. Aide d'urgence : le Becas MEC peut attribuer une aide ponctuelle en cas de difficultés financières (FNAU). Aide au logement : simulez vos droits APL/ALS sur servicios-sociales.es.",
			},
			{

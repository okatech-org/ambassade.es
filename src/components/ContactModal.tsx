				...
				<div className="space-y-5">
					...
					<div className="space-y-2">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
							...
							<div className="p-2.5 rounded-lg bg-muted/30 border border-border/40">
								<span className="text-[10px] font-medium text-muted-foreground uppercase tracking-wide block mb-0.5">
									{t("contactModal.civilStatus", "État Civil")}
								</span>
								<a
						...
						<div className="p-2.5 rounded-lg bg-red-500/5 border border-red-500/10">
							<span className="text-[10px] font-bold text-red-500 uppercase tracking-wide block mb-0.5">
								{t("contactModal.emergencies24", "Urgences 24h/24")}
							</span>
							<a
						...
						<div className="grid grid-cols-2 gap-2">
							<div className="p-2.5 rounded-lg bg-muted/30 border border-border/40">
								<div className="flex items-center justify-between mb-0.5">
									...
									>
										{t("contactModal.deposit", "Dépôt")}
									</Badge>
								</div>
								<p className="font-bold text-foreground">
									{t("contactModal.depositHours", "9h00 - 15h00")}
								</p>
							</div>
							<div className="p-2.5 rounded-lg bg-muted/30 border border-border/40">
								<div className="flex items-center justify-between mb-0.5">
									...
									<Badge
										...
										className="text-[9px] h-4 bg-primary/5 text-primary border-primary/20"
									>
										{t("contactModal.pickup", "Retrait")}
									</Badge>
								</div>
								<p className="font-bold text-foreground">
									{t("contactModal.pickupHours", "15h00 - 16h30")}
								</p>
							</div>
						</div>
					...
					<div className="space-y-2">
						...
						<div className="flex gap-2">
							<div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30 border border-border/40 flex-1">
								<div className="w-7 h-7 rounded-md bg-[#62C462] text-white flex items-center justify-center font-bold text-[10px] shrink-0">
									M9
								</div>
								<div className="text-xs">
									<p className="font-medium text-foreground">Ranelagh</p>
									<p className="text-muted-foreground">
										{t("contactModal.walkTime", "5 min à pied")}
									</p>
								</div>
							</div>
							<div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30 border border-border/40 flex-1">
								<div className="w-7 h-7 rounded-md bg-[#0088CE] text-white flex items-center justify-center font-bold text-[10px] shrink-0">
									BUS
								</div>
								<div className="text-xs">
									<p className="font-medium text-foreground">
										{t("contactModal.busLines", "Lignes 22, 52")}
									</p>
									<p className="text-muted-foreground">
										{t("contactModal.busStop", "Arrêt Ranelagh")}
									</p>
								</div>
							</div>
						</div>

	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-40 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex overflow-visible",
					side === "left"
			...
			>
				<div
					...
					className="bg-sidebar group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 flex size-full flex-col overflow-visible"
				>
					{children}
				</div>
			</div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
	...
	return (
		<button
			...
			className={cn(
				"absolute top-10 z-50 flex items-center justify-center w-7 h-24 bg-sidebar border border-l-0 border-border rounded-r-2xl shadow-[4px_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[4px_2px_12px_rgba(0,0,0,0.1)] transition-shadow cursor-pointer",
				"-right-7",
				className,
			)}
			{...props}
